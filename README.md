...
- [actions-ecosystem/action-bump-semver](https://github.com/actions-ecosystem/action-bump-semver) (1 week ago) - ⏫ GitHub Action to bump the semver version up
- [actions-ecosystem/action-release-label](https://github.com/actions-ecosystem/action-release-label) (1 week ago) - 🏷️ GitHub Action to output a semver update level from a pull request release label
