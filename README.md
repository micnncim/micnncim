...
- [micnncim/nix-darwin-example](https://github.com/micnncim/nix-darwin-example) (2 days ago) - nix-darwin-example
- [micnncim/nix-shell-example](https://github.com/micnncim/nix-shell-example) (2 days ago) - nix-shell-example
